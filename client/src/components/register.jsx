        ...
        >
          <form className="flex items-center justify-center flex-col gap-8 w-[25rem]">
            ...
            <input
              ...
              className="h-8 w-72 bg-slate-100 p-1 rounded-md font-sans font-medium text-lg outline-none"
            />
            <button className="flex items-center justify-center h-10 w-[10rem] bg-red-500 rounded-md font-sans font-medium text-lg">
              Sign Up
            </button>
          </form>
        </div>
        ...
        >
          <form className="flex items-center justify-center flex-col gap-10 w-[25rem]">
            ...
            <input
              ...
              className="h-8 w-72 bg-slate-100 p-1 rounded-md font-sans font-medium text-lg outline-none"
            />
            <button className="flex items-center justify-center h-10 w-[10rem] bg-blue-500 rounded-md font-sans font-medium text-lg">
              Sign In
            </button>
          </form>
        </div>
